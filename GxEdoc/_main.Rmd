...
knitr::include_graphics("./GxEdoc/images/GEplot1.png")
```
...
```{r, echo=FALSE, out.width="60%", fig.align="center"}
knitr::include_graphics("./GxEdoc/images/ReactionNormQuadratic.png")
```
...
knitr::include_graphics("./GxEdoc/images/DifferentReactionNorms.jpg")
```
...
knitr::include_graphics("./GxEdoc/images/stability.png")
```
...
```{r, echo=FALSE, out.width="80%", fig.align="center"}
knitr::include_graphics("./GxEdoc/images/GxEvariance.png")
```
...
knitr::include_graphics("./GxEdoc/images/GxEsimpleDiagPlots.png")
```




<!--chapter:end:01-GxEtheBasics.Rmd-->
...
<!--chapter:end:02-METandBasicModels.Rmd-->
...
<!--chapter:end:03-VarianceComponentsModel.Rmd-->
...
<!--chapter:end:04-Practical-1.Rmd-->
...
<!--chapter:end:05-FinlayWilkinson.Rmd-->
...
<!--chapter:end:07-FactorialRegression.Rmd-->
...
<!--chapter:end:09-Practical-2.Rmd-->
